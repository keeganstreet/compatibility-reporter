						...
						if (features.hasOwnProperty(featureName)) {
							...
							if (feature.css) {
								...
								if (feature.css.property) {
									feature.css.property.forEach(function(property) {
										if (property.test(declaration.prop)) {
								...
								if (feature.css.value) {
									feature.css.value.forEach(function(value) {
										if (value.test(declaration.value)) {
											addResult(featureName, feature, file.filename, declaration);
										}
									});
								}
